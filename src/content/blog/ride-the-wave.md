...
Anxiety gets worse the more you feed it. You can answer the first million questions it asks and it will have a million more. It works the same way with fear as well. But the solution isn't to just ignore these difficult emotions. It can't be, because these things will sit in the back of your mind and eat away at you from under. The rational mind wants to ask questions, analyze, probe, figure out scenarios, what ifs, etc, all of which make sense up to a certain point. On one hand, thinking feeds these emotions. On the other, not thinking leads to it coming back in full force later on. Pretty tricky.

I spent a while thinking about this subject. How do people deal with intense internal experiences? And I came across these same ideas again and again and I wanted to put them down in my own words.

There are two parts to these emotional experiences: the initial thought and the underlying feeling. The rational mind tries to resolve the thought but giving it that attention only feeds it further. There's this two arrows analogy from Buddhist thought: the first arrow is the initial bad thought/emotion/experience which is inevitable. Any number of things beyond your control can fire this first arrow into you. But the second arrow is self-inflicted, caused by resisting the first. Thinking over the problem again and again and attempting to resolve it is firing the second arrow at yourself. 

So the first step is just recognizing that first arrow. See it as a thought separate from you, without identifying with it, rather than seeing it as truth or a command.
...
The whole idea is to let a difficult emotion be there through without acting on it. Willingness. Acceptance. Surrender. To ride the wave. The wave is here whether you like it or not. If you fight it, it'll sweep you away. So, just look ahead and direct it towards a place you want to go to. 
